...
mod_gseNCG_ui <- function(id){
  ...
  tagList(
    ...
    numericInput(ns("mingssize"), label = "Minimum size of each gene set", value = 5, max = 100, min = 0, popup = "Minimum size of each gene set for analyzing"),
    numericInput(ns("maxgssize"), label = "Maximum size each gene set", value = 500, max = 5000, min = 0, popup = "Maximum size of each gene set for analyzing"),
