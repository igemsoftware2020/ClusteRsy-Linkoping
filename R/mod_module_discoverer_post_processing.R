#' module_discoverer_post_processing UI Function
#'
...
# mod_module_discoverer_post_processing_ui("module_discoverer_post_processing_ui_1")
    
## To be copied in the server
# callModule(mod_module_discoverer_post_processing_server, "module_discoverer_post_processing_ui_1")
