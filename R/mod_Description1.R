...
mod_Description1_ui <- function(id){
  ns <- NS(id)
  tagList(
    tags$div(`data-intro`= "After formating you input data you can select an inference method here!", `data-step`=2, selectInput(ns("Inference_method"), label = "Inference method", popup = "Network-based approaches to create disease modules",
...
#'
#' @noRd 
mod_Description1_server <- function(input, output, session, con, upload_ui_1, input_overview_ui_1, ppi_networks_ui_1){
  ns <- session$ns
  
  Description1_module <- reactiveValues()
  
  # Call Module only once
  CliqueSum_ui_1 <- callModule(mod_CliqueSum_server, "CliqueSum_ui_1", con = con, upload_ui_1, input_overview_ui_1, ppi_networks_ui_1)
  WGCNA_ui_1 <- callModule(mod_WGCNA_server, "WGCNA_ui_1", con = con, upload_ui_1, input_overview_ui_1)
  DIAMoND_ui_1 <- callModule(mod_DIAMoND_server, "DIAMoND_ui_1", con = con, upload_ui_1, input_overview_ui_1, ppi_networks_ui_1)
  DiffCoEx_ui_1 <- callModule(mod_DiffCoEx_server, "DiffCoEx_ui_1", con = con, upload_ui_1, input_overview_ui_1)
  MCODE_ui_1 <- callModule(mod_MCODE_server, "MCODE_ui_1", con = con, upload_ui_1, input_overview_ui_1, ppi_networks_ui_1)
  MODA_ui_1 <-callModule(mod_MODA_server, "MODA_ui_1", con = con, upload_ui_1, input_overview_ui_1)
  Modulediscoverer_ui_1 <- callModule(mod_Modulediscoverer_server, "Modulediscoverer_ui_1", con = con, upload_ui_1, input_overview_ui_1, ppi_networks_ui_1)
  CClique_ui_1 <- callModule(mod_CClique_server, "CClique_ui_1", con = con, upload_ui_1, input_overview_ui_1, ppi_networks_ui_1)
