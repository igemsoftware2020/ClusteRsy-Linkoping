             ...
             tags$div(`class`="col-sm-8", style = "height:100%",
                      ...
                      tags$a(class="grid-item", style="background-image:url('www/grid_item2.jpg');",
                             ...
                             tags$p("We provide enrichment analysis using the clusterprofiler package.",
                                    ...
                                    style="font-family:Quicksand; opacity:0; padding: 2vh 1%; font-size: 0.8vw;")),
             tags$br(),
...
If you want to investigate a certain disease you can easily do so in the Results table. ",
                                    ...
                                    style="font-family:Quicksand; opacity:0; padding: 2vh 1%; font-size: 0.9vw;")),
              ...
              tags$div(style="height: 57vh; width: 100%; margin-bottom:5%;",`class`="swiper-container",
                       tags$div(`class`="swiper-wrapper",
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item1.jpg'); background-size:contain",
                                               tags$p(class="IGEM", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;", 
                                                      "We are the iGEM 2020 team from Linköping University",
                                                      br(),
                                                      br(),
                                                      "The team concists of the ClusteRsy developers as well as an experimental group.",
                                                      br(),
                                                      "The experimental group will develop a biosensor for Asthma diagnosis using results from ClusteRsy"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item2.jpg');",
                                               tags$p(class="Adam", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;",
                                                      "My name is Adam",
                                                      br(),
                                                      br(),
                               ...
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item3.jpg');",
                                               tags$p(class="Ronja", style=" opacity:0; font-family:Quicksand;padding-top: 5vh;", 
                                                      ...
                                                      br(),
                                                      br(),
                                                      "I'm a ClusteRsy HTML/CSS developer"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item4.jpg');",
                                               tags$p(class="Alexander", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;", 
                                                      "My name is Alexander",
                                                      br(),
                                                      br(),
                                                      "I'm a ClusteRsy developer and the project leader of LiU iGEM 2020"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item5.jpg');",
                                               tags$p(class="Christina", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;", 
                               ...
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item6.jpg');",
                                               tags$p(class="Waluigi", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;", 
                                                      "My name is Waluigi",
                                                      br(),
                                                      br(),
                                                      "I'm a ClusteRsy developer"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item7.jpg');",
                                               tags$p(class="Erika", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;", 
                                                      "My name is Erika",
                                                      br(),
                                                      br(),
                                                      "I'm a CLusteRsy R shiny developer"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item8.jpg');",
                                               tags$p(class="Jake", style=" opacity:0; font-family:Quicksand; padding-top: 5vh;",
                                                      "My name is Jake",
                                                      br(),
                                                      br(),
                                                      "I'm a ClusteRsy Full Stack developer")))),
