  ...
  tagList(
    ...
    tags$div(style="height: 50vh; width: 100%; background-color:#ffbd40;",`class`="row",
             ...
             tags$div(`class`="col-sm-4 welcom-col",
                      tags$div(`class`="container con1",
                               tags$h4(`class`="conh3", "Hello World!")))),
    tags$div(`class`="row", style="height:100vh;width:100%;padding-top: 21.5vh;",
    tags$div(style="height: 57vh; width: 100%; margin-bottom:5%;",`class`="swiper-container",
             tags$div(`class`="swiper-wrapper",
                     tags$div(`class`="swiper-slide",
                              tags$div(`class`="row",
                                       tags$div(`class`="col-sm-3", style="height:100vh;padding-left:0;",
                                                tags$a(class="swiper-item", style="background-image:url('www/slick_item1.jpg');")),
                                       tags$div(`class`="col-sm-3", style="height:100vh;;",
                                       ...
                                       tags$div(`class`="col-sm-3", style="height:100vh; padding-right:0;",
