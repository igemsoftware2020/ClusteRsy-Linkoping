                       ...
                       tags$div(`class`="swiper-wrapper",
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item1.jpg');",
                                               tags$p(id="IGEM", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is IGEM", ))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item2.jpg');",
                                               tags$p(id="Adam", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Adam"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item3.jpg');",
                                               tags$p(id="Ronja", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Ronja"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item4.jpg');",
                                               tags$p(id="Alexander", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Alexander"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item5.jpg');",
                                               tags$p(id="Christina", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Christina"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item6.jpg');",
                                               tags$p(id="Waluigi", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Waluigi"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item7.jpg');",
                                               tags$p(id="Erika", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Erika"))),
                               tags$div(`class`="swiper-slide",
                                        tags$a(class="swiper-item", style="background-image:url('www/swiper_item8.jpg');",
                                               tags$p(id="Jake", style="background:transparent; opacity:0; font-family:Quicksand;", "My name is Jake")))),
